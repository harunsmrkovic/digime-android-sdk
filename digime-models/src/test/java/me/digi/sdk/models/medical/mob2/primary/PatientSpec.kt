...
class PatientSpec : ModelTest<Patient>(Patient::class.java, object : ModelParam<Patient> {
    override val emptyTest: Patient? = Patient(
            null,
            null,
            null,
            null,
    ...
    override val jsonTests: List<Pair<Patient?, String>> =
            listOf(
                    Pair(
                            emptyTest,
                            """{"dummyType": "dummy"}"""
