...
class PlaylistTrackSpec : ModelTest<PlaylistTrack>(PlaylistTrack::class.java, object : ModelParam<PlaylistTrack> {
    ...
    override val jsonTests: List<Pair<PlaylistTrack?, String>> =
            listOf(
                    Pair(
                            emptyTest,
                            """{"dummyType": "dummy"}"""
