...
class PractitionerSpec : ModelTest<Practitioner>(Practitioner::class.java, object : ModelParam<Practitioner> {
    ...
    override val jsonTests: List<Pair<Practitioner?, String>> =
            listOf(
                    Pair(
                            emptyTest,
                            """{"dummyType": "dummy"}"""
