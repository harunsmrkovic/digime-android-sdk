...
class MedicationPackageSpec : ModelTest<MedicationPackage>(MedicationPackage::class.java, object : ModelParam<MedicationPackage> {
    ...
    override val jsonTests: List<Pair<MedicationPackage?, String>> =
            listOf(
                    Pair(
                            emptyTest,
                            """{"dummyType": "dummy"}"""
